        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row" style="min-height: 400px;">
                <div class="col-lg-2" style="background-color: #3276B1;color: white;font-weight: bold;padding-left: 0px;padding-right: 0px;">
                    ...
                    if ($sys_user_role == 1) {
                        ?>
                        <div style="border-bottom: 1px solid #E7E4E4;padding: 10px;"><a style="color: white" href="main_manage.php?page=menu_type">Menu Category</a></div>
                        <div style="border-bottom: 1px solid #E7E4E4;padding: 10px;"><a style="color: white" href="main_manage.php?page=menu">Menu </a></div>
                        <div style="border-bottom: 1px solid #E7E4E4;padding: 10px;"><a style="color: white" href="main_manage.php?page=user">User</a></div>
                        <div style="border-bottom: 1px solid #E7E4E4;padding: 10px;"><a style="color: white" href="main_manage.php?page=member">Member</a></div>
                        <div style="border-bottom: 1px solid #E7E4E4;padding: 10px;"><a style="color: white" href="main_manage.php?page=discount">Discount</a></div>
                        <div style="border-bottom: 1px solid #E7E4E4;padding: 10px;"><a style="color: white" href="main_manage.php?page=table">Table</a></div>
                        <div style="border-bottom: 1px solid #E7E4E4;padding: 10px;"><a style="color: white" href="main_manage.php?page=bill_setting">Bill Setting</a></div>
                        <?php
        ...
        <script>
            ...
            $(function() {
                ...
                $(".box-bf-content").on("click", ".btn-menu-ed", function() {
                    ...
                    $(".modal-footer").html('<button type="button" class="btn btn-primary btn-edit-menu-item">Edit</button>');
                });
