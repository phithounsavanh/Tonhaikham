...
$generate_type_arr[1] = "Report Income From " . (isset($_REQUEST["s"]) ? $_REQUEST["s"] : NULL) . " To " . (isset($_REQUEST["e"]) ? $_REQUEST["e"] : NULL);
$generate_type_arr[2] = "Report Popultar Menu From " . (isset($_REQUEST["s"]) ? $_REQUEST["s"] : NULL) . " To " . (isset($_REQUEST["e"]) ? $_REQUEST["e"] : NULL);
$generate_type_arr[3] = "Report Menu Can't Cook From " . (isset($_REQUEST["s"]) ? $_REQUEST["s"] : NULL) . " To " . (isset($_REQUEST["e"]) ? $_REQUEST["e"] : NULL);
$generate_type_arr[4] = "Menu ";
$generate_type_arr[5] = "Report Table Reservation From " . (isset($_REQUEST["s"]) ? $_REQUEST["s"] : NULL) . " To " . (isset($_REQUEST["e"]) ? $_REQUEST["e"] : NULL);
...
$pdf->AddPage();
$d_start = mysql_real_escape_string(convert_date_to_mysql((isset($_REQUEST["s"]) ? $_REQUEST["s"] : NULL)));
$d_end = mysql_real_escape_string(convert_date_to_mysql((isset($_REQUEST["e"]) ? $_REQUEST["e"] : NULL)));
