            ...
            <div class="navbar navbar-inverse navbar-static-top">
                ...
                <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a style="color: #00cc00"><span class="glyphicon glyphicon-user"></span> <?php echo $sys_user . "(" . user_role($sys_user_role) . ")" ?></a>
                        </li>
                        <li>
...
//                            $tr_color = "class='success' ";
                        ...
                        ?>
                        <tr <?php echo $tr_color ?> data-id="<?php echo $order_detail_value->order_detail_id ?>">
                            <td><?php echo $order_detail_value->menu_name ?></td>
                            <td><?php echo $order_detail_value->order_quantity ?></td>
                            <td><?php echo $order_detail_value->table_name ?></td>
                            <td>
                                <?php 
                                if ($order_detail_value->order_detail_status == '3') {
                                    echo "Finish";
                            ...
                            <td><?php echo $order_detail_value->user_name ?></td>
                            <td><?php echo $order_detail_value->order_detail_date ?></td>
                        </tr>
                        <?php 
                    }
                    ?>
