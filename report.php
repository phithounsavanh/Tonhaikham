        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row" style="min-height: 400px;">
                <div class="col-lg-2" style="background-color: #3276B1;color: white;font-weight: bold;padding-left: 0px;padding-right: 0px;">
                    ...
                    <div style="border-bottom: 1px solid #E7E4E4;padding: 10px"><a style="color: white" href="report.php?page=income">Report Income</a></div>
                    <div style="border-bottom: 1px solid #E7E4E4;padding: 10px"><a style="color: white" href="report.php?page=popular_menu">Report Popular Menu</a></div>
                    <div style="border-bottom: 1px solid #E7E4E4;padding: 10px"><a style="color: white" href="report.php?page=menu_not_cook">Report Menu Can't Cook</a></div>
                    <div style="border-bottom: 1px solid #E7E4E4;padding: 10px"><a style="color: white" href="report.php?page=menu">Report Menu</a></div>
                    <div style="border-bottom: 1px solid #E7E4E4;padding: 10px"><a style="color: white" href="report.php?page=reservation">Report Table Reservation</a></div>
                </div>
                <div class="col-lg-10" >
                    <?php
